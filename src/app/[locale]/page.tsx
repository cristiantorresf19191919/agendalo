    ...
    <main className="min-h-screen overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center px-5 sm:px-8 pt-24 pb-20 text-center max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2.5 rounded-full bg-emerald-500/8 border border-emerald-500/12 px-4 py-1.5 text-[13px] font-medium text-emerald-600 dark:text-emerald-400 mb-8 backdrop-blur-sm"
          >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
              {stats.map((stat, i) => (
                <motion.div
                  ...
                  className="text-center p-6 md:p-8 rounded-2xl bg-card border border-border/50 hover:border-emerald-500/15 transition-all duration-300"
                >
                  ...
                  <p className="text-3xl sm:text-4xl font-extrabold text-gradient-primary font-display tracking-tight">{stat.value}</p>
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 py-20 md:py-28">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-display tracking-tight">{t('home.howItWorks')}</h2>
            <p className="text-muted-foreground mt-3 max-w-md mx-auto text-sm sm:text-base">{t('home.howItWorksDesc')}</p>
          </div>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {steps.map((step, i) => (
            <ScrollReveal key={i} delay={i * 0.08}>
              <div className="relative rounded-2xl p-6 bg-card border border-border/50 hover:border-emerald-500/15 transition-all duration-300 group">
                {/* Step number */}
                <div className="flex items-center gap-3 mb-5">
                  <div className="inline-flex items-center justify-center rounded-xl bg-emerald-500/8 p-3">
                    <step.icon className="h-5 w-5 text-emerald-600 dark:text-emerald-400" />
                  </div>
                  <span className="text-[11px] font-bold text-emerald-600/50 dark:text-emerald-400/40 tracking-widest uppercase font-display">{step.num}</span>
                </div>
                ...
                {/* Connector */}
                {i < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-1/2 -right-3 w-5 border-t border-dashed border-border/60" />
                )}
              </div>
            </ScrollReveal>
          ))}
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 py-20 md:py-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {features.map((feat, i) => (
            <ScrollReveal key={i} delay={i * 0.08}>
              <div className="relative rounded-2xl p-7 bg-card border border-border/50 hover:border-emerald-500/15 transition-all duration-300 group">
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {testimonials.map((item, i) => (
              <ScrollReveal key={i} delay={i * 0.08}>
                <div className="rounded-2xl p-7 bg-card border border-border/50 hover:border-emerald-500/10 transition-all duration-300 flex flex-col h-full">
                  {/* Stars */}
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 py-16 pb-28">
        <ScrollReveal>
          <div className="relative rounded-3xl overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-600/10 via-card to-card" />
            <div className="absolute inset-0 border border-emerald-500/8 rounded-3xl" />
            <div className="absolute -top-32 -left-32 w-72 h-72 rounded-full bg-emerald-500/8 blur-3xl pointer-events-none" />
